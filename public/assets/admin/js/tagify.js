    ...
    (s.prototype = {
      ...
      applySettings: function (t, e) {
        ...
        if (
          ...
          s &&
            (s = s.split(this.settings.delimiters)) instanceof Array &&
            (this.settings.blacklist = s),
          i &&
            (i = i.split(this.settings.delimiters)) instanceof Array &&
          ...
          (this.trigger = function (t, e) {
            ...
            if (t)
              if (s.settings.isJQueryPlugin)
                a(s.DOM.originalInput).triggerHandler(t, [e]);
              else {
                try {
        ...
        callbacks: {
            ...
            "mix" != this.settings.mode &&
              ("focus" == t.type
                ...
                ? (this.DOM.scope.classList.remove("tagify--focus"),
                  e && this.settings.addTagOnBlur && this.addTags(e, !0).length)
            ...
            switch (t.key) {
              case "Backspace":
                ("" != n && 8203 != n.charCodeAt(0)) ||
                  ((e = (e = this.DOM.scope.querySelectorAll(
            ...
            e
              ? this.input.value != e &&
                ...
                -1 != e.search(this.settings.delimiters)
                  ? this.addTags(e).length && this.input.set.call(this)
                  : 0 <= this.settings.dropdown.enabled &&
          ...
          onMixTagsInput: function (t) {
            ...
            window.getSelection &&
              ...
              (n = (s = i.toString().split(this.settings.mixTagsAllowedAfter))[
                s.length - 1
          ...
          onEditTagBlur: function (t) {
            ...
            (void 0 !== a && !0 !== a) ||
              ((t.textContent = n),
              (this.value[s].value = n),
              this.update(),
              (e = t.cloneNode(!0)).removeAttribute("contenteditable"),
              (i.title = n),
          ...
          onDoubleClickScope: function (t) {
            ...
            "mix" == i.mode ||
              ...
              i.enforceWhitelist ||
              !e ||
              e.classList.contains("tagify--editable") ||
      ...
      editTag: function (t) {
        ...
        i
          ? (t.classList.add("tagify--editable"),
            (i.originalValue = i.textContent),
            i.setAttribute("contenteditable", !0),
            i.addEventListener("blur", s.onEditTagBlur.bind(this, i)),
            i.addEventListener("input", s.onEditTagInput.bind(this, i)),
      ...
      input: {
        ...
        set: function () {
          ...
          (this.input.value = t),
            ...
            t || this.dropdown.hide.call(this),
            t.length < 2 && this.input.autocomplete.suggest.call(this, ""),
        ...
        validate: function () {
          var t =
            !this.input.value || this.validateTag.call(this, this.input.value);
      ...
      validateTag: function (t) {
        ...
        return (
          e
            ? i
              ? (s = this.TEXTS.exceed)
              : this.settings.pattern && !this.settings.pattern.test(e)
              ? (s = this.TEXTS.pattern)
              : this.settings.duplicates || -1 === this.isTagDuplicate(e)
      ...
      normalizeTags: function (t) {
        ...
        if (
          ...
          if (!t.trim()) return [];
          t = t
            .split(this.settings.delimiters)
            .filter(function (t) {
              return t;
            })
            .map(function (t) {
      ...
      parseMixTags: function (s) {
        ...
        return (
          s
            ...
            .forEach(function (t) {
              var e,
                i = t.replace(n.settings.pattern, "");
              n.isTagWhitelisted(i) &&
                ((e = n.normalizeTags.call(n, i)[0]),
                (s = n.replaceMixStringWithTag(s, t, e).s));
            }),
      ...
      addTags: function (t, e) {
        var s = this,
          n = [];
        if (
          ((t = this.normalizeTags.call(this, t)), "mix" == this.settings.mode)
        )
        ...
        return (
          ...
          t.forEach(function (t) {
            var e, i;
            (t = Object.assign({}, t)),
              "function" == typeof s.settings.transformTag &&
                (t.value = s.settings.transformTag.call(s, t.value) || t.value),
              !0 !== (e = s.validateTag.call(s, t.value)) &&
                ((t.class = t.class
              ...
              !0 === e
                ? (s.value.push(t),
                  s.update(),
                  s.DOM.scope.classList.toggle(
                    "hasMaxTags",
                    s.value.length >= s.settings.maxTags
                  ),
                  s.trigger("add", {
                    tag: i,
      ...
      createTagElem: function (t) {
        var e,
          i = this.escapeHtml(t.value),
          s =
            "<tag title='" +
            i +
            "' contenteditable='false' spellcheck=\"false\">\n                            <x title=''></x><div><span class='tagify__tag-text'>" +
            i +
            "</span></div>\n                        </tag>";
        if ("function" == typeof this.settings.tagTemplate)
          try {
        ...
        return (
          ...
          })((e = this.parseHTML(s)), t),
          e
        );
      },
      removeTag: function (t, e) {
        var i =
          2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 250;
      ...
      removeAllTags: function () {
        (this.value = []),
          ...
          Array.prototype.slice
            .call(this.DOM.scope.querySelectorAll("tag"))
            .forEach(function (t) {
      ...
      dropdown: {
        ...
        build: function () {
          var t =
            '<div class="' +
            ("tagify__dropdown " + this.settings.dropdown.classname).trim() +
            '"></div>';
        ...
        show: function (t) {
          ...
          if (this.settings.whitelist.length) {
            if (
              ((this.suggestedListItems = t
                ? this.dropdown.filterListItems.call(this, t)
                : this.settings.whitelist.filter(function (t) {
            ...
            (e = this.dropdown.createListHTML.call(
              ...
              (this.DOM.dropdown.innerHTML = e),
              this.dropdown.position.call(this),
              !this.DOM.dropdown.parentNode != document.body &&
          ...
          binding: function () {
            var t =
              ...
              e = (this.listeners.dropdown = this.listeners.dropdown || {
                ...
                onMouseOver:
                  this.dropdown.events.callbacks.onMouseOver.bind(this),
                onClick: this.dropdown.events.callbacks.onClick.bind(this),
              }),
              i = t ? "addEventListener" : "removeEventListener";
            window[i]("resize", e.position),
              window[i]("keydown", e.onKeyDown),
              window[i]("mousedown", e.onClick),
              this.DOM.dropdown[i]("mouseover", e.onMouseOver);
          },
          callbacks: {
            onKeyDown: function (t) {
              var e = this.DOM.dropdown.querySelectorAll(
                  "[class$='--active']"
                )[0],
                i = "";
              switch (t.key) {
                    ...
                    e ||
                      (e =
                        this.DOM.dropdown.children[
                          "ArrowUp" == t.key || "Up" == t.key
                            ? this.DOM.dropdown.children.length - 1
                            : 0
                        ]),
            ...
            onMouseOver: function (t) {
              t.target.className.includes("__item") &&
                this.dropdown.highlightOption.call(this, t.target);
            },
            onClick: function (t) {
              var e,
                i,
        ...
        filterListItems: function (t) {
          ...
          for (
            var e,
              i = [],
              s = this.settings.whitelist,
              n = this.settings.dropdown.maxItems || 1 / 0,
              a = 0;
            a < s.length &&
            (0 ==
        ...
        createListHTML: function (t) {
          var e =
            this.settings.dropdown.itemTemplate ||
            function (t) {
              return (
